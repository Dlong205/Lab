...
void setup() {
  ...
  speed_run_forward = 120;  //bạn thay đổi tốc độ ở đây, tốc độ chạy max 255, min 10
...
void loop()  // vòng lặp, không dùng delay() trong này
{
  ...
  switch (pattern) {  // đoạn mã trạng thái máy
    ...
    case 12:
      if (RememberLine == 1) {
        speed_run(speed_run_forward, -40);
        pattern = 21;
        break;
      } else if (RememberLine == -1) {
        speed_run(-40, speed_run_forward);
        pattern = 31;
        break;
      } else {
        pattern = 11;
...
void runforwardline(int tocdo)  // hàm chạy bám line
{
  switch (sensor) {
    ...
    case 0b00011100:
      ...
      RGB(0);
      line = 0;
      handleAndSpeed(servoPwm, tocdo + 10);
      break;
    case 0b00111100:
    case 0b00111110:
    case 0b01111110:
